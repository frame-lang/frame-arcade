...
func _init():
    ...
    var l: Array = H.capture(d, "find bird")
    ...
    var l2: Array = H.capture(d, "find gold")
    ...
    var l3: Array = H.capture(d2, "find emerald")
    ...
    var l6: Array = H.capture(d4, "rub lamp")
    ...
    var l7: Array = H.capture(d5, "say hello")
    _expect_any_match("SAY HELLO echoes 'Okay, hello'",
        l7, "Okay, \"hello\"")
    # SAY with no noun
    var l8: Array = H.capture(d5, "say")
