...
func _init():
    ...
    var l1: Array = H.capture(d1, "attack bear")
    ...
    var l2: Array = H.capture(d2, "attack bear")
    ...
    var l3: Array = H.capture(d3, "take bear")
    ...
    d4.fsm.bear.feed()
    var l4: Array = H.capture(d4, "take bear")
    ...
    var l5: Array = H.capture(d5, "unlock chain")
    ...
    var l6: Array = H.capture(d6, "feed bear")
